...
const CommitteeApproved = ({ approvedRequests, counts, assets }) => {
    const [activeTab, setMyActiveTab] = useState("approved");
    const router = useRouter();
    const [approvedRequestsList, setApprovedRequests] = useState(approvedRequests); // local state to update list
    ...
    // ✅ filter once
    const approvedList = approvedRequestsList.filter(item => item.status == "Y");
        ...
        if (result.isConfirmed) {
            try {
                ...
                if (res.data.success) {
                    ...
                    setApprovedRequests(prev => prev.filter(item => item.id !== itemId));
                }
            } catch (error) {
                Swal.close();
                Swal.fire({
                ...
                <div className="container">
                    ...
                    <div className="profil_deaile mx-auto">
                        ...
                        <div className="table-responsive mt-4">
                            <table className="table table-hover align-middle table-width-992 admin-table-deta-no-wrap table-mobile-width-1200">
...
export default CommitteeApproved;