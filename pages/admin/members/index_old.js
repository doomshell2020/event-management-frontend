...
const MembersTable = () => {
  ...
  //   const selectableRowIds = DATATABLE.filter((row) => row.Status === 1).map((row) => row.id);
  ...
  const [COLUMNS, setCOLUMNS] = useState([
...

    {
      ...
      Cell: ({ row }) => (
        ...
        // <div style={{ whiteSpace: "nowrap" }}>
        //   {row.original.id && !row.original.isInvited && row.original.Status === 1 && (
        //     <Button
        //       variant=""
        //       type="button"
        //       className="btn btn-sm btn-info"
            ...
            <Card className="member-fltr-hid ">
              ...
              <Card.Body className="p-2">
                ...
                >
                  ...
                  {/* old past events attended functionlity */}
                  {/* <CCol md={12}>
                    <CFormLabel htmlFor="validationDefault04">
                      Past Event attended
                    </CFormLabel>
                    ...
                    >
                      <option value="">Select</option>
                      <option value="I HAVE NEVER ATTENDED AN ONDALINDA EVENT">Not attended any event</option>
                      <option value="ANY">Attended other past events</option>
                      <option value="ONDALINDA x MONTENEGRO 2024">Attended Montenegro</option>
                    </Form.Select>
                    <CFormFeedback invalid>
                      Please provide a valid Country.
                    </CFormFeedback>
                  </CCol> */}
                  {/* 01-01-2025 Working Past Event attended*/}
                  <CCol md={12}>
                    <CFormLabel htmlFor="validationDefault04">
                      Past Event attended
                    </CFormLabel>
