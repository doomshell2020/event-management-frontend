    ...
    const fetchSalesAnalytics = async (eventId) => {
        try {
            ...
            const res = await api.get(
                `/api/v1/orders/user-sales-analytics?event_id=${id}&user_id=${userId}`
            );
            if (res.data.success) {
                        ...
                        <div className="dsa_contant">
                            <section id="post-eventpg">
                                ...
                                <h4 className="text-24">
                                    User Sales Analytics (User ID: {userId})
                                </h4>
...
export default UserSalesAnalytics;
